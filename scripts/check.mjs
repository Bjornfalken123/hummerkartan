...
if(!sw.includes('hummerkartan-shell-v9')) throw new Error('Service worker cache not bumped');
if(!html.includes('boot.js?v=3.2.0')||!html.includes('styles.css?v=3.2.0')||!app.includes("sw.js?v=3.2.0")) throw new Error('Asset version not bumped to 3.0.0');
if(!fs.readFileSync(path.join(root,'boot.js'),'utf8').includes("app.js?v=3.2.0")) throw new Error('Boot app version not bumped');
...
console.log('Hummerkartan v3.2.0: karta-i-fokus, Planering/Fiske, planned_traps, rapporter, auth och PWA-kontroller OK');
