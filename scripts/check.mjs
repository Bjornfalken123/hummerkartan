...
const required=[
  ...
  'migrations/0001_init.sql','migrations/0002_day_plans.sql','migrations/0003_planned_traps.sql','migrations/0004_position_events.sql','migrations/0005_trip_events_corrections.sql'
];
