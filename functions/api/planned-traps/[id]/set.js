...
export async function onRequestPost(context){
  try{
    ...
    const meta=positionMetaFromBody(body,lat,lon),event=positionEventStatement(db,'trap_set',trapId,meta,actor);if(event)statements.push(event);
