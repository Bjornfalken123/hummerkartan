...
export async function onRequestGet(context){
  try{
    ...
    const [traps,checks,trips,points,planned,plans,planItems]=await Promise.all([
    ...
    return json({version:3,exported_at:new Date().toISOString(),traps:traps.results||[],checks:checks.results||[],trips:trips.results||[],track_points:points.results||[],planned_traps:planned.results||[],legacy_day_plans:plans.results||[],legacy_day_plan_items:planItems.results||[]});
